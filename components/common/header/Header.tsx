...
import Toggle from "../toggleTheme/Toggler";
...
const OuterMenuLinks = styled.a`
  ${tw`w-6 h-6`}
`;

const HamburgerCtr = styled.div`
  ${tw`absolute top-0 right-0 w-6 h-6 flex items-center justify-center`}
`;
