...
export const SOCIAL_LINKS = [
  {
    name: "linkedin",
    url: "https://www.linkedin.com/in/tony-dugu%C3%A9-bb9435251",
  },
...
export const PROJECTS: IProject[] = [
  {
    ...
    description:
      "Plateforme numérique pour gérer avec simplicité les process RH de gestion des formations internes ou externes et des compétences",
  ...
  },
  {
    ...
    description:
      "Application web pour faciliter la planification de road trip en moto en groupe",
  ...
  },
  {
    ...
    description:
      "Site vitrine présentant l'activité d'une chaine de Food Truck vintage spécialisé dans les produits à base de Citron.",
  ...
  },
  {
    ...
    description:
      "Site vitrine pour améliorer la visibilité d'un pilote de drone professionnel",
...
export const SKILLS = {
  frontend: [
    ...
    },
    {
      ...
      name: "TypeScript (TS)",
      description:
        "Langage de programmation libre et open source développé par Microsoft qui a pour but d'améliorer et de sécuriser la" +
    ...
    },
    {
      ...
      name: "React",
      description:
        "Bibliothèque JavaScript libre développée par Facebook depuis 2013. Le but principal de cette bibliothèque est de faciliter la création" +
    ...
    },
    {
      ...
      name: "NextJS",
      description:
        "Framework gratuit et open source s'appuyant sur la bibliothèque JavaScript React et sur la technologie Node.js.",
    },
    {
      id: 5,
      filename: "redux",
      name: "Redux",
      description:
        "Bibliothèque open-source JavaScript de gestion d'état pour applications web. Elle est plus couramment utilisée avec des bibliothèques" +
    ...
    },
    {
      ...
      name: "GraphQL",
      description:
        "Langage de requêtes et un environnement d'exécution, créé par Facebook en 2012, avant d'être publié comme projet open-source en" +
    ...
    },
    {
      ...
      name: "Gatsby",
      description:
        "Générateur de site statique open source construit sur Node.js en utilisant React et GraphQL. Utilisé en JamStack.",
    },
    {
      id: 10,
      filename: "sass",
    ...
    },
    {
      ...
      name: "HTML",
      description:
        "Le HyperText Markup Language, généralement abrégé HTML ou, dans sa dernière version, HTML5, est le langage de balisage conçu pour" +
    ...
    },
    {
      ...
      name: "CSS",
      description:
        "Les feuilles de style en cascade, généralement appelées CSS de l'anglais Cascading Style Sheets, forment un langage informatique qui décrit" +
  ...
  backend: [
    {
      ...
      name: "NodeJS",
      description:
        "Plateforme logicielle libre en JavaScript, orientée vers les applications réseau évènementielles hautement concurrentes qui doivent" +
    ...
    },
    {
      ...
      name: "NestJS",
      description:
        "Frameworks Node.js pour construire des applications backend efficaces, évolutives et de niveau entreprise en utilisant" +
    ...
    },
    {
      ...
      name: "express",
      description:
        "Framework pour construire des applications web basées sur Node.js. C'est de fait le framework standard pour le développement de" +
        " serveur en Node.js.",
    },
    {
      id: 4,
      ...
      name: "PHP",
      description:
        "Le PHP (PHP Hypertext Preprocessor ) est un langage de scripts généraliste et Open" +
    ...
    },
    {
      ...
      name: "Symfony",
      description:
        "Framework MVC libre écrit en PHP avec un ensemble de composants PHP. Fournit des fonctionnalités modulables et adaptables qui" +
    ...
    },
    {
      ...
      name: "MongoDB",
      description:
        "Système de gestion de base de données orienté documents, répartissable sur un nombre quelconque d'ordinateurs et ne nécessitant pas" +
  ...
  userInterface: [
    ...
    },
    {
      ...
      description:
        "Logiciel de création graphique vectorielle. Il fait partie de la gamme Adobe, peut être utilisé indépendamment ou en" +
    ...
    },
    {
      ...
      name: "Blender",
      description:
        "Logiciel libre de modélisation, d’animation par ordinateur et de rendu en 3D, créé en 1998. Il est actuellement développé par la" +
    ...
    },
    {
      ...
      name: "ThreeJS",
      description:
        "Bibliothèque JavaScript pour créer des scènes 3D dans un navigateur web. Elle peut être utilisée avec la balise canvas du HTML5 sans" +
  ...
  other: [
    {
      ...
      name: "Git",
      description:
        "Système de contrôle de version permettant de gérer et de suivre l'historique d'un code source.",
    },
    {
      id: 2,
      filename: "docker",
      name: "Docker",
      description:
        "Plateforme permettant de lancer certaines applications dans des conteneurs logiciels. Permet de faciliter la coordination des" +
    ...
    },
    {
      ...
      name: "Webpack",
      description:
        "Outil logiciel open-source de type « module bundler », conçu pour faciliter le développement et la gestion de sites et" +
    ...
    },
    {
      ...
      name: "Gulp",
      description:
        "Automatiseur de tâches en JavaScript (task runner) utilisé en développement web frontend.",
    },
    {
      id: 5,
      filename: "postman",
...
export const TIMELINE: Array<TimelineNode> = [
  ...
  {
    type: NodeTypes.CHECKPOINT,
    title: "Concepteur & développeur FullStack (OPEN)",
    size: ItemSize.LARGE,
  ...
  },
  {
    ...
    subtitle:
      "Application web pour faciliter la planification de road trip à moto en groupe avec une approche collaborative et une expérience utilisateur intuitive",
  ...
  },
  {
    ...
    period: "2018-2019",
    subtitle:
      "Création d'un site vitrine pour un pilote de drone professionnel afin d'apporter une présence en ligne et faciliter les demandes de clients potentiels",
  ...
  },
  {
    ...
    size: ItemSize.LARGE,
    subtitle:
      "Participation à des missions embarquées de coopération de surveillance des pêches sur des patrouilleurs de Madagascar / Ile Maurice / Seychelles",
  ...
  },
  {
    ...
    size: ItemSize.LARGE,
    subtitle:
      "Surveillance des pêches & exploitation d'imagerie satellite pour lutter contre la pêche illicite dans l'Océan Indien",
